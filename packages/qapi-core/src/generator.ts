...
import { toSafeString, log } from './utils'

export const DEFAULT_OPTIONS: Options = {
  $refOptions: {},
  bannerComment: `/**
* This file was automatically generated by qapi.
...
*/`,
  ...
  ignoreMinAndMaxItems: false, // 忽略 最大最小值
...
function generateStandaloneInterface(ast: TNamedInterface, options: Options): string {
  return (
    ...
    (ast.superTypes.length > 0
      ? `extends ${ast.superTypes
          .map(superType => toSafeString(superType.standaloneName))
          .join(', ')} `
      : '') +
